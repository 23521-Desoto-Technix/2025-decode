...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = 75.994;
        FollowerConstants.yMovement = 57.9893;

        FollowerConstants.forwardZeroPowerAcceleration = -33.7785;
        FollowerConstants.lateralZeroPowerAcceleration = -68.6524;

        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.3,0,0.01,0);
        FollowerConstants.useSecondaryTranslationalPID = false;
        FollowerConstants.secondaryTranslationalPIDFCoefficients.setCoefficients(0.1,0,0.01,0); // Not being used, @see useSecondaryTranslationalPID

        FollowerConstants.headingPIDFCoefficients.setCoefficients(6,0,0.5,0);
