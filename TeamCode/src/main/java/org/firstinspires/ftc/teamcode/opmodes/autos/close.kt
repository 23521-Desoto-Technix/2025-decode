...
class close : NextFTCOpMode() {
  ...
  private fun PoseSet.mirrored(): PoseSet {
    return PoseSet(
        ...
        gateMid = mirrorPose(gateMid),
        spike3 = mirrorPose(spike3),
        park = mirrorPose(park),
    )
  }
    ...
    return AutoPaths(
        ...
        shootToSpike2 =
            PedroComponent.follower
                ...
                .addPath(BezierCurve(poses.spike2, poses.gateMid, poses.gate))
        ...
        shootToPark =
            PedroComponent.follower
                .pathBuilder()
                .addPath(BezierLine(poses.shoot, poses.park))
                .setConstantHeadingInterpolation(poses.park.heading)
                .build(),
    )
  }
