    ...
    object Poses {
        private val redPoses =
            linkedMapOf<String, Pose>().apply {
                ...
                pose("shove", Pose(110.0, 130.0, -90.0.deg.inRad))
                ...
                pose("gateProgressive", Pose(125.0, 66.0, 0.0.deg.inRad))
    ...
    object Angles {
        private val angles =
            linkedMapOf<String, Angle>().apply {
                angle("closeTurretRed", (-85.0).deg)
                angle("closeTurretBlue", 92.0.deg)
    ...
    private fun buildPathsFor(
        ...
        return linkedMapOf<String, PathChain>().apply {
            ...
            path(
                ...
                follower
                    .pathBuilder()
                    .addPath(BezierLine(p("start"), p("shove")))
                    .setLinearHeadingInterpolation(p("start").heading, p("shove").heading)
                    .build(),
            )
            path(
                "shootToSpike1",
