    ...
    object Poses {
        private val redPoses =
            linkedMapOf<String, Pose>().apply {
                ...
                pose("gateHit", Pose(127.0, 75.0, -90.0.deg.inRad))
                pose("gateHitCtrl", Pose(120.0, 58.0, -90.0.deg.inRad))
                pose("gateIntake", Pose(131.7, 57.5, 30.0.deg.inRad))
    ...
    object Angles {
        private val angles =
            linkedMapOf<String, Angle>().apply {
                ...
                angle("parkTurretRed1", (-110.0).deg)
                angle("parkTurretBlue1", 110.0.deg)
